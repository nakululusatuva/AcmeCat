...
namespace DNS
{
	...
	public:
		 ...
		 *     "globalApiKey": ""
		 * } */
		explicit Cloudflare(const Json::Value& apiParams);
		~Cloudflare() = default;
	...
	// TODO: Implementation of DnsPod's API
	class DnsPod : public API
	{
	public:
	private:
	};
	
	// TODO: Implementation of GoDaddy's API
	class GoDaddy : public API
	{
	public:
	private:
	};
